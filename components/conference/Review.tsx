...
const Review: FC = () => {
    ...
    return (
        <div className="review" id="section_3">
            <div className={`${styles.container}   ${styles.animated}`}>
                <h2>往届活动回顾</h2>
                <div className="review_item">
                    <img src="https://conf.freecodecamp.one/assets/review1.png" className="revImg"/>
                    <p>2017 年 11 月，freeCodeCamp 成都社区举办 Web 前端交流大会，八百余人报名，四百余人参会，获得本地政府及全国各企业、媒体、社区的广泛关注与大力支持。</p>
                </div>
                <div className="review_item">
                    <img src="https://conf.freecodecamp.one/assets/review2.png" className="revImg"/>
