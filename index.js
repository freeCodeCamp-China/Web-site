var data = {
  ...
  chengdu: {
	  ...
	  history:[],
	  speaker: [
	    { name: 'Adieu', pic: 'Adieu.png', link: '' },
	    { name: 'Ak', pic: 'Ak.png', link: '' },
	    { name: 'Helen', pic: 'Helen.png', link: '' },
	    { name: 'Steven Ou', pic: 'steven_Ou.png', link: '' },
	    { name: '陈斌', pic: 'chenbin.png', link: '' },
	    { name: '陈嘉', pic: 'chenjia.png', link: '' },
	    { name: '陈津', pic: 'chenjin.png', link: '' },
	    { name: '陈洋彬', pic: 'chenyangbin.png', link: '' },
	    { name: '代波', pic: 'daibo.png', link: '' },
	    { name: '董涛', pic: 'dongtao.png', link: '' },
	    { name: '杜屹东', pic: 'duyidong.png', link: '' },
	    { name: '范卿麟', pic: 'fanqinlin.png', link: '' },
	    { name: '樊晓兵', pic: 'fanxiaobin.png', link: '' },
	    { name: '郭洪伟', pic: 'guohongwei.png', link: '' },
	    { name: '郭庆', pic: 'guoqing.png', link: '' },
	    { name: '胡桓铭', pic: 'huhengming.png', link: '' },
	    { name: '胡敏', pic: 'huming.png', link: '' },
	    { name: '胡胜全', pic: 'hushengquan.png', link: '' },
	    { name: '姜姜姜', pic: 'jiangjiang.png', link: '' },
	    { name: '简念', pic: 'jiannian.png', link: '' },
	    { name: '梁桐铭', pic: 'liangtongmin.png', link: '' },
	    { name: '廖伟', pic: 'liaowei.png', link: '' },
	    { name: '林水强', pic: 'linshuiqiang.png', link: '' },
	    { name: '刘博', pic: 'liubo.png', link: '' },
	    { name: '刘杰', pic: 'liujie.png', link: '' },
	    { name: '刘洋河', pic: 'liuyanghe.png', link: '' },
	    { name: '李万鹏', pic: 'liwanpeng.png', link: '' },
	    { name: '龙佳文', pic: 'longjiawen.png', link: '' },
	    { name: '卢林', pic: 'lulin.png', link: '' },
	    { name: '吕靖', pic: 'lvjing.png', link: '' },
	    { name: '吕彦', pic: 'lvyan.png', link: '' },
	    { name: '毛玉峰', pic: 'maoyufeng.png', link: '' },
	    { name: '潘越', pic: 'panyue.png', link: '' },
	    { name: '钱晟龙', pic: 'qianshenglong.png', link: '' },
	    { name: '卿粼波', pic: 'qinlinbo.png', link: '' },
	    { name: '任远', pic: 'renyuan.png', link: '' },
	    { name: '沈长锟', pic: 'shenchangkun.png', link: '' },
	    { name: '水歌', pic: 'shuige.png', link: '' },
	    { name: '苏龙', pic: 'sulong.png', link: '' },
	    { name: '唐超', pic: 'tangchao.png', link: '' },
	    { name: '田泱', pic: 'tianyang.png', link: '' },
	    { name: '王蒙', pic: 'wangmeng.png', link: '' },
	    { name: '闻其详', pic: 'wenqixiang.png', link: '' },
	    { name: '吴浩麟', pic: 'wuhaolin.png', link: '' },
	    { name: '徐孝增', pic: 'xuxiaozen.png', link: '' },
	    { name: '杨鸿翼', pic: 'yanghongyi.png', link: '' },
	    { name: '杨义天', pic: 'yangyitian.png', link: '' },
	    { name: '叶小钗', pic: 'yexiaochai.png', link: '' },
	    { name: '余泽江', pic: 'yuzejiang.png', link: '' },
	    { name: '曾磊', pic: 'zenlei.png', link: '' },
	    { name: '张瑞', pic: 'zhangrui.png', link: '' },
	    { name: '张伟', pic: 'zhangwei.png', link: '' },
	    { name: '赵芝明', pic: 'zhaozhiming.png', link: '' }
	  ],
	  partner: [
	    { pic: 'BBD.png', link: '' },
